...
@IBDesignable class SwipeActionButton: UIButton {
    ...
    convenience init(action: SwipeAction) {
        ...
        setBackgroundImage(action.image, for: .normal)
        setBackgroundImage(action.highlightedImage ?? action.image, for: .highlighted)
        self.sharedInit()
    }

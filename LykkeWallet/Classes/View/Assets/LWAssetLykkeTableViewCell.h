...
@property (weak, nonatomic) IBOutlet UILabel *leftAssetNameLabel;
@property (weak, nonatomic) IBOutlet UILabel *rightAssetNameLabel;
...
@property (weak, nonatomic) IBOutlet UIImageView *assetReverseImageView;

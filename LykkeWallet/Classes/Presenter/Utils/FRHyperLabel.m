...
-(void) awakeFromNib
{
    ...
    FRHyperLabelLinkColorDefault = [UIColor colorWithRed:171.0/255.0 green:0/255.0 blue:255.0/255.0 alpha:1];
    FRHyperLabelLinkColorHighlight = FRHyperLabelLinkColorDefault;
